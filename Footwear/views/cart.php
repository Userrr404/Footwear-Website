  ...
  <div class="container">
    <?php if (!isset($_SESSION['user_id'])): ?>
        <p style="text-align:center;">
          Please <a class="text-blue-500" href="<?= BASE_URL ?>views/login.php">login</a> to view your cart.
        </p>
    <?php else: ?>
        <?php
        ...
        <?php if (empty($cart_items)): ?>
          <p class="empty">Your cart is empty. 
            <a class="text-blue-500" href="<?= BASE_URL ?>views/products.php">Start shopping</a>!
          </p>
        <?php else: ?>
